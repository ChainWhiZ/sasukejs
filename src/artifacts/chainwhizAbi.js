export const chainwhiz = [
  {
    inputs: [
      { internalType: "address", name: "_ChainwhizAdmin", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { anonymous: false, inputs: [], name: "ActivateContract", type: "event" },
  ...
  {
    inputs: [
      { internalType: "string", name: "_issueLink", type: "string" },
      { internalType: "string", name: "_solverGithubId", type: "string" },
    ],
    name: "initiateEscrow",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "solverRewardAmount", type: "uint256" },
      {
        internalType: "uint256",
        name: "communityVoterRewardAmount",
        type: "uint256",
      },
      { internalType: "uint256", name: "startSolveTime", type: "uint256" },
      { internalType: "uint256", name: "endSolveTime", type: "uint256" },
      { internalType: "uint256", name: "startVoteTime", type: "uint256" },
      { internalType: "uint256", name: "endVoteTime", type: "uint256" },
      { internalType: "bool", name: "isCommunityVote", type: "bool" },
      {
        internalType: "enum ChainwhizCore.QuestionStatus",
        name: "questionStatus",
        type: "uint8",
      },
      { internalType: "bool", name: "isUnstakeSet", type: "bool" },
      {
        components: [
          { internalType: "address", name: "solver", type: "address" },
          { internalType: "string", name: "solutionLink", type: "string" },
          { internalType: "uint256", name: "timeOfPosting", type: "uint256" },
          {
            internalType: "address[]",
            name: "voterAddress",
            type: "address[]",
  ...
  {
    inputs: [
      { internalType: "address", name: "_publisherAddress", type: "address" },
      { internalType: "string", name: "_issueGithubUrl", type: "string" },
  ...
  {
    inputs: [
      { internalType: "string", name: "_githubId", type: "string" },
      { internalType: "string", name: "_githubUrl", type: "string" },
      { internalType: "uint256", name: "_solverRewardAmount", type: "uint256" },
      {
        internalType: "uint256",
        name: "_communityVoterRewardAmount",
        type: "uint256",
      },
      { internalType: "uint256", name: "_endSolverTime", type: "uint256" },
      { internalType: "uint256", name: "_startVoteTime", type: "uint256" },
      { internalType: "uint256", name: "_endVoteTime", type: "uint256" },
  ...
  },
  {
    inputs: [
      { internalType: "string", name: "_githubId", type: "string" },
      { internalType: "string", name: "_solutionLink", type: "string" },
      { internalType: "string", name: "_issueGithubUrl", type: "string" },
      { internalType: "address", name: "_publisherAddress", type: "address" },
      { internalType: "string", name: "_publisherGithubId", type: "string" },
    ],
    name: "postSolution",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_approvalAmount", type: "uint256" },
    ],
    name: "setApproval",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_newChainwhizAdmin", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_ethGateWayAddress", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string[]", name: "_solutionLinks", type: "string[]" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_aMaticAddress", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "string", name: "_solutionLink", type: "string" }],
    name: "unstake",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "returnRewardAmount", type: "uint256" },
      { internalType: "uint256", name: "returnBaseAmount", type: "uint256" },
      { internalType: "string", name: "rewardToken", type: "string" },
