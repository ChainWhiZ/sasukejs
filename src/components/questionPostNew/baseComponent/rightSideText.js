                ...
                <Grid container direction="">
                    ...
                    <Grid item md={12} xs={12} className="button-parent">
                        <Grid container direction="row" container
                            ...
                            alignItems="center">
                            <Grid item md={6} xs={6}>
                                <Button size="small" variant="contained" className="button" onClick={(e)=>{e.preventDefault(); if(props.pageState>0 && props.pageState<5){props.handlePageChange(props.pageState-1)}}}>Previous</Button>
                            </Grid>
                            <Grid item md={6} xs={6}>
                                <Button size="small" variant="contained" className="button" onClick={(e)=>{e.preventDefault(); if(props.pageState>0 && props.pageState<5){props.handlePageChange(props.pageState+1)}}}>Next</Button>
                            </Grid>
                        </Grid>
