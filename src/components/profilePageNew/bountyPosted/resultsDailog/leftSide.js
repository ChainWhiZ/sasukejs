        ...
        <>
            <div className="results-dialog-left-grid" >
                <Grid item md={12} xs={12} className="results-dialog-left-grid-heading">
                    <p className="results-dialog-heading" style={{textAlign:"center"}}>All Solution Posted</p>
                </Grid>
                ...
                {props.solutions &&
                    ...
                    props.solutions.map((solution) => (
                        <Grid
                            ...
                            md={12}
                            xs={12}
                            onClick={()=>props.handleSelectedSolution(solution)}
                            className={
                                props.selectedSolution === solution
